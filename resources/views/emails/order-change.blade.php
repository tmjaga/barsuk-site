...
@section('content')
    ...
    <div class="p-6 border-gray-200">
        ...
        <h6 class="text-md text-gray-600 font-semibold mb-4">@lang('Date: ') {{ \Carbon\Carbon::parse($order['order_start'])->format('d.m.Y H:i') }}</h6>
        ...
        <div class="space-y-4">
            ...
            <div class="border-t pt-4 mt-4">
                <div class="flex justify-between font-semibold text-lg">
                    ...
                    <span>{{ minutes_to_hhmm((int) $order['services_sum_duration']) }}</span>
                </div>
                <div class="flex justify-between font-semibold text-lg">
                    <span>@lang('Total')</span>
                    <span>&euro; {{ $order['services_sum_price'] }}</span>
                </div>
            </div>
        </div>
    </div>
