                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3 whitespace-nowrap items-center">
                            <div class="flex w-full items-center justify-center gap-2">
                                <a x-bind:href="`{{ route('admin.albums.edit', ':id') }}`.replace(':id', album.id)" data-tippy-content="@lang('Edit Album')" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                                ...
                                <x-common.confirm-delete
                                    ...
                                    <!-- Trash icon -->
                                    <button data-tippy-content="@lang('Delete Album')" class="flex items-center justify-center text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
                                        <svg class="fill-current" width="24" height="24" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a x-bind:href="`{{ route('admin.albums.show', ':id') }}`.replace(':id', album.id)" data-tippy-content="@lang('View Photos')" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                                    {!! \App\Helpers\MenuHelper::getIconSvg('camera') !!}
                                </a>
                            </div>
                        </td>
                    </tr>
