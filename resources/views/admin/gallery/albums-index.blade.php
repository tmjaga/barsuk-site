    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="max-w-full overflow-x-auto custom-scrollbar">
            <table class="min-w-full">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3 whitespace-nowrap items-center">
                            <div class="flex w-full items-center justify-center gap-2">
                                <a href="{{ route('admin.albums.edit',$album->id) }}" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
                ...
                @empty
                    <tr>
                        <td class="text-muted text-center" colspan="100%">{{ __('No Albums found') }}</td>
                    </tr>
                @endforelse
                </tbody>
                <!-- table body end -->
