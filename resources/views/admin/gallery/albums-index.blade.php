                    ...
                    <tr x-data="statusBadge">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap items-center">
                            <div class="flex w-full items-center justify-center gap-2">
                                ...
                                <a x-bind:href="`{{ route('admin.albums.media.index', ':id') }}`.replace(':id', album.id)" data-tippy-content="@lang('View Photos')" class="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white/90">
