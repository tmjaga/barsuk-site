...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white">
        <div x-data="image_validate('{{ $image?->getUrl() ?? '' }}')"  class="space-y-6 border-t border-gray-100 p-5 sm:p-6">
                ...
                <div class="-mx-2.5 w-full">
                    ...
                    <div class="w-1/2 px-2.5 mb-5">
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select name="move_to_album" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 z-20 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden " :class="isOptionSelected &amp;&amp; 'text-gray-500'" @change="isOptionSelected = true">
                    ...
                    <div class="w-full px-2.5">
                        <div class="mt-10 flex items-center gap-3">
                            ...
                            <a href="{{ route('admin.albums.media.index', $album->id) }}" class="flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-800">
                                @lang('Cancel')
                            </a>
                        </div>
                    </div>
