    ...
    <div x-data="serviceModal()">
        ...
        <div class="flex flex-col gap-3 sm:flex-row items-center p-3">
            ...
            <div class="relative ml-auto">
                ...
                <input x-model.debounce.500ms="search" type="text" placeholder="Search..." class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-4 pl-[42px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[300px] dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
            </div>

            <!-- category select input-->
            <div x-data="{ isOptionSelected: {{ $category ? 'true' : 'false' }} }" class="relative z-20 bg-transparent">
                <select x-model="filters.category" @change="$dispatch('reload-items');" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" :class="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'" @change="isOptionSelected = true">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 whitespace-nowrap">
                        <div class="flex items-center justify-center">
                            <p class="items-center font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                @lang('Duration (min)')
                            </p>
                        </div>
                    </th>
                ...
                <div @click.outside="isModalOpen = false" class="relative w-full max-w-[584px] rounded-3xl bg-white p-6 lg:p-10">
                    ...
                    <form @submit.prevent="submitForm" method="POST" :action="formAction">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <input name="title" value="" x-model="formData.title" type="text" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex items-center gap-2">
                                <!-- Hours -->
                                <input x-model="formData.hours" type="number" name="hours" placeholder="HH" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden">
                                <span class="text-gray-500 font-semibold">:</span>
                                <!-- Minutes -->
                                <input x-model="formData.minutes" type="number" name="minutes" placeholder="MM" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden">
            ...
            Alpine.data('serviceModal', () => ({
                ...
                async openEditModal(serviceId) {
                    ...
                    try {
                        ...
                        console.log('dur: ', service.duration)
