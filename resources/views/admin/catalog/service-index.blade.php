                    ...
                    <tr x-data="statusBadge">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap items-center">
                            <div class="flex w-full items-center justify-center gap-2">
                                <a href="#" @click.prevent="openEditModal(service.id)" data-tippy-content="@lang('Edit Service')" class="text-gray-500 hover:text-gray-800">
                                ...
                                <x-common.confirm-delete
                                    ...
                                    <!-- Trash icon -->
                                    <button @click="itemId = service.id" data-tippy-content="@lang('Delete Service')" class="flex items-center justify-center text-gray-500 hover:text-error-500">
                                        <svg class="fill-current" width="24" height="24" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <form @submit.prevent="submitForm" method="POST" :action="formAction">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select x-model="formData.category_id" name="category_id" class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" :class="isOptionSelected &amp;&amp; 'text-gray-800'" @change="isOptionSelected = true">
                                    <option value="" class="text-gray-700">
                                        @lang('Select Category')
                                    </option>
                                    @foreach ($categories as $cat)
